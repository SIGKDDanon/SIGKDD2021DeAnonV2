...
def main():
    '''Debugging only'''
    reward_in_file = '/Users//banditalgorithms/data/effectSizeDebugging/tbb_rewards_393_1.csv'
    reward_out_file = '/Users//banditalgorithms/data/effectSizeDebugging/reordered_tbb_rewards_393_1.csv'
