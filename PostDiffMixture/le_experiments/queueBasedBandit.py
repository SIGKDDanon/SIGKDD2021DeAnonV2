...
def get_sampling_dist(heuristic_dist, base_dist, num_actions, target_index, queue_sizes, max_queue_size, mixing_weight):
    ...
    while cur_index != -1: 
        ...
        # Note: Talked to ,  on original paper, and original has error on lines
...
def main():
    ...
    immediate_input_file = "/Users/a/git/banditalgorithms/src/le_experiments/imm/input/gauss_single_bandit_input_immediate_cor-0.25sample1.csv"
    true_input_file = "/Users/a/git/banditalgorithms/src/le_experiments/true/input/gauss_single_bandit_input_true_cor-0.25sample1.csv"
    #immediate_input_file = "/Users//banditalgorithms/data/gauss_single_bandit_input_immediate_cor0.75sample1.csv"
    #true_input_file = "/Users//banditalgorithms/data/gauss_single_bandit_input_true_cor0.75sample1.csv"
    immediate_output_file = "/Users/a/git/banditalgorithms/src/le_experiments/true/input/gauss_single_bandit_output_debug3_immediate_cor-0.25sample1.csv"
    true_output_file = "/Users/a/git/banditalgorithms/src/le_experiments/true/input/gauss_single_bandit_output_debug3_true_cor-0.25sample1.csv"
