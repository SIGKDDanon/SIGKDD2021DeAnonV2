...
def debug():
    calculate_averages_for_sim_directory('/Users//banditalgorithms/data/reorderedRewardsSimulations/ngEqualMeansArmsLow1.25/', False)
#     betaModels = []
...
#     print("probability bigger:", prob_bigger,"; avg. difference:", avg_difference)
#     
#     betaModels = get_models_from_simulation('/Users//banditalgorithms/data/reorderedRewardsSimulations/tbb_actions_44_138.csv', True)
#     prob_bigger, avg_difference = simulate_prob_condition1_bigger(betaModels)
#     print("probability bigger:", prob_bigger,"; avg. difference:", avg_difference)
# 
#     normalModels = get_models_from_simulation('/Users//banditalgorithms/data/reorderedRewardsSimulations/tng_actions_104_80.csv', False)
