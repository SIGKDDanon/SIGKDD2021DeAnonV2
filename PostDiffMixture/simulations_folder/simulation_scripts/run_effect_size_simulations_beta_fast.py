...
def run_simulations(num_sims, prob_per_arm, step_sizes, outfile_directory,
    ...
    random_dur=0, random_start=0, mode=''):
    '''
...
def main():
        ...
        if bandit_type == "uniform":
            ...
            if len(sys.argv) > 5:
                ...
                run_simulations(num_sims, prob_per_arm, step_sizes,
                    ...
                    batch_size = batch_size, burn_in_size = burn_in_size)
    ...
    for results_df, results_output_name in zip(results_dfs_list, results_output_names):
        results_df.to_csv('{}_sims={}_m={}.csv'.format(results_output_name, num_sims, random_dur_m))
