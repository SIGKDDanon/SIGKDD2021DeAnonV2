...
#simSetDescriptive=$timestamp"NoEffect_fixedbs_forcutoffs" #Give descriptive name for directory to save set of sims
#simSetDescriptive="NoEffect_fixedbs_RL4RLMay8" #Give descriptive name for directory to save set of sims
simSetDescriptive="../simulation_saves/NoEffect_fixedbs_TEST"
...
#     echo $directoryName
#     mkdir $directoryName
#     python3 ~/banditalgorithms/src/le_experiments/run_effect_size_simulations.py 0.0 0.0 $curVariance $numSims $directoryName "uniform" $curN 2> $directoryName"/errorOutput.log" > $directoryName"/output.log" &
#     echo $!
# done
...
#     echo $directoryName
#     mkdir $directoryName
#     python3 ~/banditalgorithms/src/le_experiments/run_effect_size_simulations.py 0.0 0.0 $curVariance $numSims $directoryName "Thompson" $curN 2> $directoryName"/errorOutput.log" > $directoryName"/output.log" &
#     echo $!
# done
...
#     echo $directoryName
#     mkdir $directoryName
#     python3 ~/banditalgorithms/src/le_experiments/run_effect_size_simulations.py 0.5 0.5 $curVariance $numSims $directoryName "Thompson" $curN 2> $directoryName"/errorOutput.log" > $directoryName"/output.log" &
#     echo $!
# done
...
#     echo $directoryName
#     mkdir $directoryName
#     python3 ~/banditalgorithms/src/le_experiments/run_effect_size_simulations_beta.py 0.5,0.5 $numSims $directoryName "uniform" "armsEqual" $curN 2> $directoryName"/errorOutput.log" > $directoryName"/output.log" &
#     echo $!
# done


#/Users//Documents/School/Summer_2019/IPW\ \ /banditalgorithms/src/
# arrayLength=${#nsB[@]};
# for ((i=0; i<$arrayLength; i++)); do
#     curN=${nsB[$i]}
...
#     echo $directoryName
#     mkdir $directoryName
#     python3 ~/banditalgorithms/src/le_experiments/run_effect_size_simulations_beta.py 0.5,0.5 $numSims $directoryName "Thompson" "armsHigh" $curN 2> $directoryName"/errorOutput.log" > $directoryName"/output.log" &
#     echo $!
# done
...
#     echo $directoryName
#     mkdir $directoryName
#     python3 ~/banditalgorithms/src/le_experiments/run_effect_size_simulations_beta.py 0.5,0.5 $numSims $directoryName "Thompson" "armsLow" $curN 2> $directoryName"/errorOutput.log" > $directoryName"/output.log" &
#     echo $!
# done
