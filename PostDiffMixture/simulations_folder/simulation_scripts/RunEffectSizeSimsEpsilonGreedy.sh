...
simSetDescriptive="../simulation_saves/EpsilonGreedyIsEffectFast" #Give descriptive name for directory to save set of sims
mkdir -p $simSetDescriptive

effectSizesB=(0.08 0.1 0.3 0.5);
...
for ((i=0; i<$arrayLength; i++)); do
   ...
   # mkdir -p $root_dir
    ...
    python3 run_effect_size_simulations_beta_fast_EpsilonGreedy.py \
