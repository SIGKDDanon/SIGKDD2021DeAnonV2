...
#     echo $directoryName
#     mkdir $directoryName
#     python3 /Users//Documents/School/Summer_2019/IPW\ \ /banditalgorithms/src/le_experiments/run_effect_size_simulations.py \
...
#     echo $directoryName
#     mkdir $directoryName
#     python3 ~/banditalgorithms/src/le_experiments/run_effect_size_simulations.py 0.5 -0.5 $curEffectSize $numSims $directoryName 2> $directoryName"/errorOutput.log" > $directoryName"/output.log" &
#     echo $!
# done
...
# 	echo $directoryName
# 	mkdir $directoryName
#     python3 /Users//Documents/School/Summer_2019/IPW\ \ /banditalgorithms/src/le_experiments/run_effect_size_simulations_beta.py \
# #    python3 /home//IPW___copy/banditalgorithms/src/le_experiments/run_effect_size_simulations_beta.py \
