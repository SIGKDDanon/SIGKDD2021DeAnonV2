...
simSetDescriptive="../simulation_saves/PPDGreedyNoEffectResampleFast" #Give descriptive name for directory to save set of sims
...
for ((i=0; i<$arrayLength; i++)); do
	...
	python3 run_effect_size_simulations_beta_fast_PPDGreedy.py \
