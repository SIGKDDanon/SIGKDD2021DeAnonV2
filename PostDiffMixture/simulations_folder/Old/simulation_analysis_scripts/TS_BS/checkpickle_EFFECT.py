...
import os
import sys
sys.path.insert(1, '/home//__Fall_2019/banditalgorithms/src/RL4RLSectionB/simulation_analysis_scripts')
import pandas as pd 
...
#                edgecolor='black', alpha = alpha_bs, hatch = hatch_bs)
    ...
    if ax_idx == 0:
        leg1 = ax.legend((p3[0], p4[0]), ('Thompson Sampling \n Wald', "Uniform Wald"), loc = "upper left", bbox_to_anchor=(-0.15, 1.6))
        ax.add_artist(leg1)
