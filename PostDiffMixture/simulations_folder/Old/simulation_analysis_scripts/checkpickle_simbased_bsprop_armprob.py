...
import sys
#sys.path.insert(1, '/home//__Fall_2019/banditalgorithms/src/le_experiments/')
# print(data)
import numpy as np
import os
...
def stacked_bar_plot_with_cutoff(df_ts = None, df_eg0pt1 = None, df_eg0pt3 = None, df_unif = None, n = None, num_sims = None, \
                     ...
                     ax = None, ax_idx = None, epsilon = None):
...
#EpsilonGreedyIsEffect/num_sims=5armProb=0.5/es=0.3epsilon=0.1/
    ...
    root_ts = "/home//__Fall_2019/banditalgorithms/src/EpsilonGreedy/TS_sims_with_wo_bs/NoEffect_fixedbs_RL4RLMay8/num_sims={}armProb=0.5".format(num_sims)
...
#
        ...
        df.to_csv("../simulation_analysis_saves/Tables/Type1Error_n={}_numsims={}.csv".format(n, num_sims)) 
...
root = "../simulation_saves/EpsilonGreedyNoEffect"
