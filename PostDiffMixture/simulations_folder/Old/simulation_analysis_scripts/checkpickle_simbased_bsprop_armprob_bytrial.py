...
#EpsilonGreedyIsEffect/num_sims=5armProb=0.5/es=0.3epsilon=0.1/
    ...
    dir_cur = "/home//__Fall_2019/banditalgorithms/src/EpsilonGreedy/EpsilonGreedyNoEffect/num_sims={}armProb=0.5/N={}epsilon={}/".format(num_sims, n,epsilon)
# /home//__Fall_2019/banditalgorithms/src/EpsilonGreedy/EpsilonGreedyNoEffect/num_sims=500armProb=0.5/N=785epsilon=0.1/bbUnEqualMeansUniformburn_in_size-batch_size=1-1BU0N785DfByTrial.pkl
    ...
    t1_all_steps_ts = pd.read_pickle("banditsGraphs/180123BinaryPowerSameArms.pkl")
